...
#pragma warning disable CS4014
        ...
        internal async Task HandleLBAuth()
        {
            ...
            _leaderboardView.OnLeaderboardSet(_leaderboardView.currentDifficultyBeatmap);
            SharedCoroutineStarter.instance.StartCoroutine(UIUtils.GetSpriteAvatar($"{Constants.USER_URL_API(_authenticationManager._localPlayerInfo.userID)}/avatar", (Sprite a, string b) => _panelView.playerAvatar.sprite = a, (string a, string b) => _panelView.playerAvatar.sprite = Utilities.FindSpriteInAssembly("BloqParty.Images.Player.png"), new CancellationToken()));
